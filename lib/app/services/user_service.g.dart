...
class _UserService implements UserService {
  ...
  @override
  Future<PasswordResponse> uptadePass(PasswordPostModel model) async {
    const _extra = <String, dynamic>{};
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PasswordResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PasswordResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<MessageResponse> getMessage(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': id};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<AddFavoriteResponse> addFavorite(AddFavoritePost model) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<AddFavoriteResponse> deleteUser(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': id};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<AddFavoriteResponse> deleteAdv(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': id};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<AddFavoriteResponse> deleteFavorite(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'id': id};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
